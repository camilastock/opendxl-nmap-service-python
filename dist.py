...
VERSION = __import__('dxlnmapservice').get_version()
RELEASE_NAME = "dxlnmapservice-python-dist-" + str(VERSION)
CONFIG_RELEASE_NAME = "dxlnmapservice-python-dist-config-" + str(VERSION)
...
subprocess.check_call(["sphinx-apidoc",
                       ...
                       os.path.join(DIST_PY_FILE_LOCATION, "dxlnmapservice")])
...
print("\nRemoving dxlnmapservice.egg-info\n")
remove_tree(os.path.join(DIST_PY_FILE_LOCATION, "dxlnmapservice.egg-info"))
